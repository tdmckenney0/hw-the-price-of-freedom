...
Launching = {familyDontAvoidOnLaunch = "SmallRock"}
Parade = {
    ParadeDefaultGrowthSpacing = 300,
    rallyPointMinDistance = 2500
}

AdvRigidBody = {SpaceFriction = 0.2}
...
OrderData = {maxDistanceFromGoal = 90}
WeaponFire = {FriendlyFireRatio = 0}
